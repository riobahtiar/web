export const en = {
  ...
  contact: {
    ...
    description:
      "Have a project in mind or want to discuss a potential collaboration? I'm here to help you bring your ideas to life.",
    ...
    form: {
      ...
      newsletterConsent:
        "I would like to receive occasional updates and newsletters (optional)",
    },
    inquiryTypes: {
    ...
    faq: {
      ...
      questions: [
        ...
        },
        {
          ...
          answer:
            "For the most accurate quote, please include project details, desired features, timeline expectations, and any design references you may have.",
        },
        {
          question: "How do you handle project revisions?",
          answer:
            "My process includes dedicated revision phases where you can provide feedback and request changes to ensure the final product meets your expectations.",
        },
        {
          question: "What payment methods do you accept?",
          answer:
            "I accept payments via bank transfer, PayPal, and major credit cards. For larger projects, I typically work with a milestone-based payment schedule.",
        },
      ],
    },
  },
